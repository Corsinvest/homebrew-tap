...
| [cv4pve-diag](https://github.com/Corsinvest/cv4pve-diag) | `cv4pve-diag` | 2.4.0 | Diagnostic tool for Proxmox VE — checks nodes, VMs, LXC containers and storage for common issues |
